...
export default function CentralRegWaitlists() {
  ...
  const rows = useMemo(() => {
    ...
    ellLearners.filter(l => l.enrollment_status === 'waitlisted').forEach(l => wl.push({ key: `l-${l.id}`, area: 'ell', id: l.id, name: `${l.first_name} ${l.last_name}`, program: l.interested_course_name || 'ELL Program', position: null, date: l.waitlist_date || l.intake_date }));
