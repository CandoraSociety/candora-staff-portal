...
import { ArrowLeft, Plus, Trash2, Download, ExternalLink, FolderOpen, Search, FileText } from "lucide-react";
                ...
                <CardContent className="p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                      ...
                      <button onClick={() => window.open(`/filemanager/view?id=${file.id}`, "_blank")} className="h-8 w-8 rounded flex items-center justify-center hover:bg-muted">
