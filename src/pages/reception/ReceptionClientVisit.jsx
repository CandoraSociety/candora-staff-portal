...
export default function ReceptionClientVisit() {
  ...
  const OPTIONS = [
    { key: 'grab_and_go', label: 'Grab and Go Resources', description: 'Bus tickets, emergency food, supplies and other quick resources', icon: ShoppingBasket, action: () => setGrabGoOpen(true) },
  ...
  return (
    <div className="space-y-4 max-w-3xl mx-auto">
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">Select a client, then log a grab-and-go resource, drop-in casework or scheduled visit</p>
      </div>
