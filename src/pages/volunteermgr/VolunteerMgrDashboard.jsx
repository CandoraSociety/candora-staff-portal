...
import { Users, Briefcase, Calendar, Clock, Award, CheckSquare } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-4">
        ...
        <StatCard icon={Clock} label="Currently Signed In" value={activeSignIns} color="text-green-600" />
