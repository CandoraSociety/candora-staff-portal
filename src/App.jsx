...
import PathwaysWorkshops from '@/pages/pathways/PathwaysWorkshops';
    ...
    <Routes>
      ...
      <Route element={<ProtectedRoute unauthenticatedElement={<Navigate to="/login" replace />} />}>
        ...
        <Route element={<EDLayout />}>
          ...
          <Route path="/ed/training" element={<EDTrainingPlanner />} />
          <Route path="/ed/schedule" element={<EDScheduleMaker />} />
        </Route>
        ...
        <Route element={<PathwaysLayout />}>
          ...
          <Route path="/pathways/workshops" element={<PathwaysWorkshops />} />
