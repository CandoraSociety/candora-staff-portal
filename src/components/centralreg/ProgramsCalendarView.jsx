...
// Shared program calendar view — rendered identically in the Central
// Registration portal and the Reception portal.
export default function ProgramsCalendarView() {
