...
// Shared Programs & Registration view — rendered identically in the Central
// Registration portal and the Reception portal. Both portals hit the same
// entities, so registrations created in either place appear in both instantly.
export default function ProgramsRegistrationView() {
