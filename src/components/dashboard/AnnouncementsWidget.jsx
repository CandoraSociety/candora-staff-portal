...
const priorityConfig = {
  urgent: { color: 'bg-destructive/10 text-destructive border-destructive/20' },
  high: { color: 'bg-accent/10 text-accent-foreground border-accent/20' },
  normal: { color: 'bg-primary/10 text-primary border-primary/20' },
