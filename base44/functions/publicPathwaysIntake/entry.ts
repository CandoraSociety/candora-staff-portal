...
Deno.serve(async (req) => {
  try {
    ...
    const client = await base44.asServiceRole.entities.Client.create({
      ...
      income_source_other: data.income_source_other?.trim() || null,
      legally_entitled_to_work: data.legally_entitled_to_work || null,
      drivers_license_status: data.drivers_license_status || null,
      has_alternate_id: data.has_alternate_id || null,
      has_phone_access: data.has_phone_access || null,
      has_internet_access: data.has_internet_access || null,
      available_immediately: data.available_immediately || null,
      current_programming: data.current_programming?.trim() || null,
      previous_employment_program: data.previous_employment_program || null,
      has_criminal_record: data.has_criminal_record || null,
      highest_education: data.highest_education || null,
      has_sin: data.has_sin || null,
      resume_urls: data.resume_urls || null,
